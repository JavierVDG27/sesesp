...
<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-white leading-tight">
            {{ __('Captura de expediente técnico') }}
        </h2>
    </x-slot>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <select name="tipo_recurso" id="tipo_recurso"
                                    ...
                                    <option value="Federal" {{ old('tipo_recurso') == 'Federal' ? 'selected' : '' }}>Federal</option>
                                    <option value="Estatal" {{ old('tipo_recurso') == 'Estatal' ? 'selected' : '' }}>Estatal</option>
                                    <option value="Mixto"   {{ old('tipo_recurso') == 'Mixto'   ? 'selected' : '' }}>Mixto</option>
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <select name="anio_ejercicio" id="anio_ejercicio"
                                    ...
                                    @foreach($anios as $anio)
                                        <option value="{{ $anio }}" {{ old('anio_ejercicio', $anioActual) == $anio ? 'selected' : '' }}>
                                            {{ $anio }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <select name="eje" id="eje"
                                    ...
                                    @foreach (['01','02','03','04','05'] as $eje)
                                        <option value="{{ $eje }}" {{ old('eje') == $eje ? 'selected' : '' }}>
                                            {{ $eje }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <select name="programa" id="programa"
                                    ...
                                    @foreach (range(1,14) as $num)
                                        ...
                                        <option value="{{ $val }}" {{ old('programa') == $val ? 'selected' : '' }}>
                                            {{ $val }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <select name="subprograma" id="subprograma"
                                    ...
                                    @foreach (range(1,33) as $num)
                                        @php $val = str_pad($num, 2, '0', STR_PAD_LEFT); @endphp
                                        <option value="{{ $val }}" {{ old('subprograma') == $val ? 'selected' : '' }}>
                                            {{ $val }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <select name="area_ejecutora" id="area_ejecutora"
                                        ...
                                        focus:ring-[#691C32] focus:border-[#691C32]">
                                    <option value="">Seleccione...</option>
                                    <option value="01" {{ old('area_ejecutora') == '01' ? 'selected' : '' }}>01 - Secretaría de Seguridad Pública del Estado</option>
                                    <option value="02" {{ old('area_ejecutora') == '02' ? 'selected' : '' }}>02 - Fiscalía General de Justicia del Estado</option>
                                    <option value="03" {{ old('area_ejecutora') == '03' ? 'selected' : '' }}>03 - Secretariado Ejecutivo del Sistema Estatal de Seguridad Pública / Consejo Estatal</option>
                                    <option value="04" {{ old('area_ejecutora') == '04' ? 'selected' : '' }}>04 - Instituto Jalisciense de Ciencias Forenses</option>
                                    <option value="05" {{ old('area_ejecutora') == '05' ? 'selected' : '' }}>05 - Coordinación General de Prevención del Delito</option>
                                    <option value="06" {{ old('area_ejecutora') == '06' ? 'selected' : '' }}>06 - Secretaría de Gobierno</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <script>
                        (function() {
                            ...
                            function recalcularTotalGeneral() {
                                ...
                                document.getElementById('total_general_financiamiento').value =
    ...
    {{-- Script directamente dentro del componente --}}
    <script>
