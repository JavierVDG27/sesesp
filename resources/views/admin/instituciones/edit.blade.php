        ...
        <div class="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3">
            <div>
                ...
                <p class="text-white/80 text-sm mt-1">
                    Actualiza datos de la institución y guarda los cambios.
                </p>
            </div>
            ...
            <div class="bg-white shadow-sm rounded-2xl border border-gray-200 overflow-hidden">
                ...
                <div class="px-6 py-5 border-b border-gray-100">
                    <div class="flex items-start gap-3">
                        ...
                        <div class="min-w-0">
                            <h1 class="text-lg font-semibold text-gray-800">Actualizar institución</h1>
                    ...
                    <div class="mt-4 rounded-2xl bg-gray-50 border border-gray-200 p-4">
                        <p class="text-xs text-gray-500 uppercase tracking-wider">Institución seleccionada</p>
                        <p class="font-semibold text-gray-800 mt-1 break-words">{{ $institucion->nombre }}</p>
                        <p class="text-sm text-gray-600 mt-1">
                            Siglas: <span class="font-semibold">{{ $institucion->siglas ?? '—' }}</span>
                        </p>
                    </div>
                </div>

                <div class="p-6">
                    <form method="POST" action="{{ route('admin.instituciones.update', $institucion) }}" class="space-y-6">
                        @csrf
                        @method('PUT')
